...
pub trait Io {
    ...
    /// # Safety
    ///
    /// The `val` ans `offset` must be valid; more precisely, the port adding
    /// the offset must be present and the value must satisfy the demands of
    /// I/O devices.
    ...
    /// 2. The `val` ans `offset` must be valid; more precisely, the port adding
    /// the offset must be present and the value must satisfy the demands of
    /// I/O devices.
    ...
    /// # Safety
    ///
    /// The `val` must be valid; more precisely, the value must satisfy the
    /// demands of I/O devices.
    ...
    ///
    /// 1. The I/O permission must be satisfied.
    /// 2. The `value` must be valid; more precisely, the value must satisfy the
    /// demands of I/O devices.
